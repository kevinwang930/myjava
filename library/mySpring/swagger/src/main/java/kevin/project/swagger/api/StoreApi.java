...
public interface StoreApi {
    ...
    ResponseEntity<Void> deleteOrder(@DecimalMin("1.0")@ApiParam(value = "ID of the order that needs to be deleted",required=true) @PathVariable("orderId") String orderId);
