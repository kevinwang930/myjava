...
public final class GreeterGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<kevin.project.grpc.HelloRequest,
      kevin.project.grpc.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = kevin.project.grpc.HelloRequest.class,
      responseType = kevin.project.grpc.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<kevin.project.grpc.HelloRequest,
      kevin.project.grpc.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<kevin.project.grpc.HelloRequest, kevin.project.grpc.HelloReply> getSayHelloMethod;
    if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
      synchronized (GreeterGrpc.class) {
        if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
          GreeterGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<kevin.project.grpc.HelloRequest, kevin.project.grpc.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  kevin.project.grpc.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  kevin.project.grpc.HelloReply.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void sayHello(kevin.project.grpc.HelloRequest request,
        io.grpc.stub.StreamObserver<kevin.project.grpc.HelloReply> responseObserver) {
  ...
  public static final class GreeterStub
    ...
    /**
     */
    public void sayHello(kevin.project.grpc.HelloRequest request,
        io.grpc.stub.StreamObserver<kevin.project.grpc.HelloReply> responseObserver) {
  ...
  public static final class GreeterBlockingStub
    ...
    /**
     */
    public kevin.project.grpc.HelloReply sayHello(kevin.project.grpc.HelloRequest request) {
  ...
  public static final class GreeterFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<kevin.project.grpc.HelloReply> sayHello(
        kevin.project.grpc.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((kevin.project.grpc.HelloRequest) request,
              (io.grpc.stub.StreamObserver<kevin.project.grpc.HelloReply>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              kevin.project.grpc.HelloRequest,
              kevin.project.grpc.HelloReply>(
  ...
  private static abstract class GreeterBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return kevin.project.grpc.HelloWorldProto.getDescriptor();
    }
